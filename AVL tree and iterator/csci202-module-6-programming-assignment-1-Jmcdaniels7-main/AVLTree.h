...
private:
    ...
    Iterator find(const T &searchItem, const binaryNode<T> *currentNode) const;
};
...
template <class T>
typename AVLTree<T>::Iterator AVLTree<T>::find(const T &searchItem, const binaryNode<T> *currentNode) const
{
